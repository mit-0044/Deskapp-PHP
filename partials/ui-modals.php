					...
					<div class="col-md-4 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							...
							<a href="#" class="btn-block" data-toggle="modal" data-target="#bd-example-modal-lg" type="button">
								<img src="../assests/vendors/images/modal-img1.jpg" alt="modal" />
							</a>
					...
					<div class="col-md-4 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							...
							<a href="#" class="btn-block" data-toggle="modal" data-target="#Medium-modal" type="button">
								<img src="../assests/vendors/images/modal-img2.jpg" alt="modal" />
							</a>
					...
					<div class="col-md-4 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							...
							<a href="#" class="btn-block" data-toggle="modal" data-target="#small-modal" type="button">
								<img src="../assests/vendors/images/modal-img3.jpg" alt="modal" />
							</a>
												...
												<div class="select-role">
													<div class="btn-group btn-group-toggle" data-toggle="buttons">
														<label class="btn active">
															...
															<div class="icon">
																<img src="../assests/vendors/images/briefcase.svg" class="svg" alt="" />
															</div>
															<span>I'm</span>
															Manager
														</label>
														<label class="btn">
															...
															<div class="icon">
																<img src="../assests/vendors/images/person.svg" class="svg" alt="" />
															</div>
															<span>I'm</span>
															Employee
														</label>
