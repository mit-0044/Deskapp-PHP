				...
				<div class="row clearfix">
					...
					<div class="col-md-6 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							...
							<p>
								<code>&lt;a&gt;</code>s don’t support the disabled attribute,
								so you must add the <code>.disabled</code> class to make it
					...
					<div class="col-md-6 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							...
							<p>
								Add <code>data-toggle="button"</code> to toggle a button’s
								<code>active</code> state. If you’re pre-toggling a button,
								you must manually add the <code>.active</code> class and
								<code>aria-pressed="true"</code> to the
								<code>&lt;button&gt;</code>.
							</p>
							<div class="btn-list">
					...
					<div class="col-md-6 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							...
							<p>
								...
								<code>data-toggle="buttons"</code> to a
								<code>.btn-group</code> containing those modified buttons to
								enable toggling in their respective styles.
							</p>
					...
					<div class="col-md-6 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							...
							<p>
								...
								with a series of buttons.Make a set of buttons appear
					...
					<div class="col-md-6 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							...
							<div class="btn-list">
								...
								<button type="button" class="btn" data-bgcolor="#3d464d" data-color="#ffffff">
									<i class="fa fa-dropbox"></i> dropbox
								</button>
								<button type="button" class="btn" data-bgcolor="#db4437" data-color="#ffffff">
									<i class="fa fa-google-plus"></i> google-plus
								</button>
								<button type="button" class="btn" data-bgcolor="#bd081c" data-color="#ffffff">
									<i class="fa fa-pinterest-p"></i> pinterest
								</button>
								<button type="button" class="btn" data-bgcolor="#00aff0" data-color="#ffffff">
