...
<body>
		...
		<div class="pd-ltr-20">
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					<div class="col-md-4">
						<img src="../assests/vendors/images/banner-img.png" alt="" />
					</div>
					<div class="col-md-8">
			...
			<div class="card-box mb-30">
				...
				<table class="data-table table nowrap">
					...
					<tbody>
						<tr>
							<td class="table-plus">
								<img src="../assests/vendors/images/product-1.jpg" width="70" height="70" alt="" />
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="../assests/vendors/images/product-2.jpg" width="70" height="70" alt="" />
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="../assests/vendors/images/product-3.jpg" width="70" height="70" alt="" />
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="../assests/vendors/images/product-4.jpg" width="70" height="70" alt="" />
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="../assests/vendors/images/product-5.jpg" width="70" height="70" alt="" />
							</td>
							<td>
	...
	<script src="../assests/vendors/scripts/dashboard.js"></script>
